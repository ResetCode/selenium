...
//	private static int s_question = 0;
	...
	public static int handle(AuData data, ChromeDriver driver, String offerUrl, String wish) throws InterruptedException {
		...
		try {
			...
			Thread.sleep(3000);
			driver.findElementByXPath("//*[@id=\"number_and_street\"]").sendKeys(data.getAddress());
			Thread.sleep(3000);
			...
			for(int i = 0; i < 20; i++) {
				...
				if(answer(driver, 4045, getNumberHas0(2))) continue;
				...
				if(answer(driver, 1213, getNumber(11))) continue;
